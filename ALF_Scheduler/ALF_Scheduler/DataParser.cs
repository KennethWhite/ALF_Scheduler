...
namespace ALF_Scheduler {
    ...
    class DataParser {
        ...
        /// <summary>
        /// This method creates the facility's previous year's inspection <paramref name="date"/> 
        /// by using the CreateDateTime method here: <see cref="DataParser.CreateDateTime(string date)"/>.
        /// </summary>
        /// <param name="date">The facility's previous year's inspection date as a string.</param>
